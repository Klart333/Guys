...
public static class NoiseS3D {
	...
	private static string noShaderMsg = "Could not find the noise compute shader. Did you _move/rename any of the files?";
	
	/// <summary> 
	/// Uses the GPU to generate a RenderTexture where the pixels in the _texture represent noise.
	/// Set the octaves variable before calling this to a desired value.
	/// </summary>
	/// <returns>RenderTexture</returns>
	/// <param name="width"> Width of the _texture to generate. </param>
	/// <param name="height"> Height of the _texture to generate. </param>
	/// <param name="noiseOffsetX"> X Coordinate of the offset for the noise on the _texture. </param>
	/// <param name="noiseOffsetY"> Y Coordinate of the offset for the noise on the _texture. </param>
	...
	/// <summary> 
	/// Uses the GPU to generate a Texture2D where the pixels in the _texture represent noise.
	/// Set the octaves variable before calling this to a desired value.
	/// </summary>
